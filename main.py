...
if __name__ == "__main__":
    ...
    criminal_record = CriminalRecord(name='fdsfsdfsdf')
    prisoners = [
        Prisoner(name='afdfdsfsdfsdf', nickname='fdsfdsfsdfd', surname='dfdsfdsfsdfs', birth_date=datetime(1999, 5, 17),
                 country=country, criminal_records=[criminal_record]) for _ in range(30)]  # Creating 30 prisoners
